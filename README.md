...
⭐ **481,217 Stars**（+284）　🍴 **53,124 Forks**（+37）　/　🟢 **1,943 Open Issues**　/　Python
...
⭐ **389,997 Stars**（+102）　🍴 **81,983 Forks**（+27）　/　🟢 **7,676 Open Issues**　/　TypeScript
...
⭐ **288,111 Stars**（+507）　🍴 **25,770 Forks**（+50）　/　🟢 **372 Open Issues**　/　Shell
...
⭐ **264,450 Stars**（+865）　🍴 **22,303 Forks**（+69）　/　🟢 **502 Open Issues**　/　Shell
...
⭐ **261,126 Stars**（+899）　🍴 **39,088 Forks**（+139）　/　🟢 **227 Open Issues**　/　JavaScript
...
⭐ **246,541 Stars**（+353）　🍴 **51,638 Forks**（+173）　/　🟢 **43,776 Open Issues**　/　Python
...
⭐ **213,693 Stars**（+261）　🍴 **21,623 Forks**（+15）　/　🟢 **130 Open Issues**　/　不明
...
⭐ **195,263 Stars**（+5）　🍴 **108,511 Forks**（-18）　/　🟢 **45 Open Issues**　/　Rust
...
⭐ **181,662 Stars**（+372）　🍴 **9,835 Forks**（+12）　/　🟢 **641 Open Issues**　/　TypeScript
...
⭐ **181,166 Stars**（-22）　🍴 **17,919 Forks**（+12）　/　🟢 **4,033 Open Issues**　/　Go
...
⭐ **176,880 Stars**（+173）　🍴 **20,940 Forks**（+17）　/　🟢 **1,240 Open Issues**　/　Python
...
⭐ **156,185 Stars**（前日なし）　🍴 **24,662 Forks**（前日なし）　/　🟢 **1,097 Open Issues**　/　TypeScript
...
⭐ **154,947 Stars**（+50）　🍴 **10,108 Forks**（+2）　/　🟢 **1,087 Open Issues**　/　Python
...
⭐ **153,165 Stars**（+273）　🍴 **24,710 Forks**（+53）　/　🟢 **149 Open Issues**　/　Shell
...
⭐ **145,849 Stars**（+374）　🍴 **23,622 Forks**（+147）　/　🟢 **12,452 Open Issues**　/　TypeScript
...
⭐ **143,699 Stars**（+23）　🍴 **34,820 Forks**（+1）　/　🟢 **162 Open Issues**　/　不明
...
⭐ **141,291 Stars**（+973）　🍴 **7,574 Forks**（+35）　/　🟢 **274 Open Issues**　/　JavaScript

Topics: `agent-skills` / `ai-agents` / `claude` / `claude-code` / `claude-code-plugin` / `cursor-rules` / `developer-tools` / `llm`

## 18位 [garrytan/gstack](https://github.com/garrytan/gstack)

Use Garry Tan's exact Claude Code setup: 23 opinionated tools that serve as CEO, Designer, Eng Manager, Release Manager, Doc Engineer, and QA

⭐ **133,467 Stars**（+109）　🍴 **19,891 Forks**（+23）　/　🟢 **903 Open Issues**　/　TypeScript
...
⭐ **133,392 Stars**（+186）　🍴 **9,200 Forks**（+17）　/　🟢 **2,749 Open Issues**　/　Rust
...
⭐ **128,506 Stars**（+321）　🍴 **13,702 Forks**（+30）　/　🟢 **86 Open Issues**　/　Python
...
⭐ **124,447 Stars**（+182）　🍴 **19,277 Forks**（+44）　/　🟢 **31 Open Issues**　/　Python
...
⭐ **119,042 Stars**（+609）　🍴 **11,512 Forks**（+62）　/　🟢 **1,388 Open Issues**　/　Python
...
⭐ **114,981 Stars**（+147）　🍴 **12,652 Forks**（+19）　/　🟢 **435 Open Issues**　/　Python
...
⭐ **107,312 Stars**（+313）　🍴 **20,508 Forks**（+77）　/　🟢 **343 Open Issues**　/　Python

Topics: `agent` / `finance` / `llm` / `multiagent` / `trading`

## 25位 [google-gemini/gemini-cli](https://github.com/google-gemini/gemini-cli)

An open-source AI agent that brings the power of Gemini directly into your terminal.

⭐ **107,041 Stars**（+21）　🍴 **14,600 Forks**（+7）　/　🟢 **852 Open Issues**　/　TypeScript
...
⭐ **106,267 Stars**（+230）　🍴 **6,154 Forks**（+19）　/　🟢 **124 Open Issues**　/　Go
...
⭐ **96,766 Stars**（+194）　🍴 **11,246 Forks**（+28）　/　🟢 **1,088 Open Issues**　/　TypeScript

Topics: `agent-skills` / `ai-design` / `byok` / `claude-code-for-design` / `claude-design` / `codex-design` / `coding-agents` / `cursor-design`

## 28位 [microsoft/playwright](https://github.com/microsoft/playwright)

Playwright is a framework for Web Testing and Automation. It allows testing Chromium, Firefox and WebKit with a single API.

⭐ **96,281 Stars**（+53）　🍴 **6,456 Forks**（+8）　/　🟢 **184 Open Issues**　/　TypeScript
...
⭐ **95,824 Stars**（+411）　🍴 **10,144 Forks**（+35）　/　🟢 **126 Open Issues**　/　JavaScript
...
⭐ **95,584 Stars**（-2）　🍴 **9,575 Forks**（-1）　/　🟢 **260 Open Issues**　/　TypeScript
...
⭐ **94,134 Stars**（+83）　🍴 **8,306 Forks**（+10）　/　🟢 **206 Open Issues**　/　TypeScript
...
⭐ **90,422 Stars**（+27）　🍴 **11,651 Forks**（+10）　/　🟢 **543 Open Issues**　/　TypeScript
...
⭐ **89,685 Stars**（+74）　🍴 **8,853 Forks**（+17）　/　🟢 **378 Open Issues**　/　TypeScript

Topics: `editor` / `oss` / `videoeditor`

## 34位 [ChatGPTNextWeb/NextChat](https://github.com/ChatGPTNextWeb/NextChat)
...
⭐ **88,780 Stars**（+5）　🍴 **59,057 Forks**（-2）　/　🟢 **865 Open Issues**　/　TypeScript
...
⭐ **88,326 Stars**（+149）　🍴 **11,601 Forks**（+26）　/　🟢 **812 Open Issues**　/　TypeScript
...
⭐ **87,974 Stars**（+292）　🍴 **5,982 Forks**（+18）　/　🟢 **67 Open Issues**　/　JavaScript
...
⭐ **86,692 Stars**（+50）　🍴 **13,147 Forks**（+17）　/　🟢 **379 Open Issues**　/　TypeScript
...
⭐ **84,968 Stars**（+5）　🍴 **25,209 Forks**（+98）　/　🟢 **31 Open Issues**　/　Blade
...
⭐ **83,756 Stars**（+60）　🍴 **8,661 Forks**（+12）　/　🟢 **201 Open Issues**　/　Python

Topics: `topicなし`

## 40位 [Egonex-AI/Understand-Anything](https://github.com/Egonex-AI/Understand-Anything)

Graphs that teach > graphs that impress. Turn any code into an interactive knowledge graph you can explore, search, and ask questions about. Works with Claude Code, Codex, Cursor, Copilot, Gemini CLI, and more.

⭐ **83,162 Stars**（+90）　🍴 **7,011 Forks**（+10）　/　🟢 **304 Open Issues**　/　TypeScript
...
## 41位 [Panniantong/Agent-Reach](https://github.com/Panniantong/Agent-Reach)

Give your AI agent eyes to see the entire internet. Read & search Twitter, Reddit, YouTube, GitHub, Bilibili, XiaoHongShu — one CLI, zero API fees.

⭐ **82,795 Stars**（+286）　🍴 **7,241 Forks**（+35）　/　🟢 **144 Open Issues**　/　Python

Topics: `agent-infrastructure` / `ai-agent` / `ai-search` / `automation` / `bilibili` / `claude-code` / `cli` / `cursor`

## 42位 [bytedance/deer-flow](https://github.com/bytedance/deer-flow)

An open-source long-horizon SuperAgent harness that researches, codes, and creates. With the help of sandboxes, memories, tools, skill, subagents and message gateway, it handles different levels of tasks that could take minutes to hours.

⭐ **82,596 Stars**（+49）　🍴 **11,394 Forks**（+6）　/　🟢 **884 Open Issues**　/　Python

Topics: `agent` / `agentic` / `agentic-framework` / `agentic-workflow` / `ai` / `ai-agents` / `deep-research` / `harness`

## 43位 [lobehub/lobehub](https://github.com/lobehub/lobehub)

🤯 LobeHub is your Chief Agent Operator, organizing your agents into 7×24 operations by hiring, scheduling, and reporting on your entire AI team.

⭐ **82,552 Stars**（+12）　🍴 **15,895 Forks**（-2）　/　🟢 **918 Open Issues**　/　TypeScript
...
⭐ **81,849 Stars**（+377）　🍴 **8,313 Forks**（+53）　/　🟢 **6 Open Issues**　/　Python

Topics: `ai` / `ai-scraping` / `automation` / `crawler` / `crawling` / `crawling-python` / `data` / `data-extraction`

## 45位 [paperclipai/paperclip](https://github.com/paperclipai/paperclip)

The open-source app everyone uses to manage agents at work

⭐ **80,944 Stars**（+78）　🍴 **14,855 Forks**（+10）　/　🟢 **5,479 Open Issues**　/　TypeScript
...
⭐ **80,833 Stars**（+90）　🍴 **5,122 Forks**（+10）　/　🟢 **1,638 Open Issues**　/　Rust
...
⭐ **79,146 Stars**（+88）　🍴 **9,663 Forks**（+14）　/　🟢 **145 Open Issues**　/　Python
...
⭐ **77,059 Stars**（+96）　🍴 **12,391 Forks**（+11）　/　🟢 **52 Open Issues**　/　Python
...
⭐ **76,315 Stars**（+66）　🍴 **6,956 Forks**（+11）　/　🟢 **1,234 Open Issues**　/　Python
...
⭐ **74,545 Stars**（+28）　🍴 **4,255 Forks**（±0）　/　🟢 **2,833 Open Issues**　/　TypeScript
...
⭐ **74,177 Stars**（+18）　🍴 **6,742 Forks**（+3）　/　🟢 **11 Open Issues**　/　MDX
...
⭐ **73,156 Stars**（+68）　🍴 **7,566 Forks**（+6）　/　🟢 **113 Open Issues**　/　Python
...
⭐ **72,773 Stars**（+279）　🍴 **5,593 Forks**（+27）　/　🟢 **672 Open Issues**　/　Python
...
⭐ **72,722 Stars**（+86）　🍴 **8,611 Forks**（+10）　/　🟢 **972 Open Issues**　/　TypeScript
...
⭐ **71,717 Stars**（+6）　🍴 **5,646 Forks**（±0）　/　🟢 **457 Open Issues**　/　不明
...
⭐ **71,325 Stars**（+163）　🍴 **4,578 Forks**（+5）　/　🟢 **517 Open Issues**　/　C

Topics: `topicなし`

## 57位 [stablyai/orca](https://github.com/stablyai/orca)

Orca is the ADE for working with a fleet of parallel agents. Run any coding agent with your own subscription. Available on desktop, mobile and remote runtime.

⭐ **71,100 Stars**（+844）　🍴 **4,650 Forks**（+59）　/　🟢 **6,246 Open Issues**　/　TypeScript

Topics: `ade` / `agent-ide` / `ai-agents` / `claude-code` / `cli` / `codex` / `cursor-agent` / `devtools`

## 58位 [code-yeongyu/oh-my-openagent](https://github.com/code-yeongyu/oh-my-openagent)

OmO: Just type "mass ulw" keyword with your prompt. Now you are the master of graph engineering.

⭐ **69,154 Stars**（+42）　🍴 **5,690 Forks**（+2）　/　🟢 **1,028 Open Issues**　/　TypeScript
...
⭐ **68,759 Stars**（+239）　🍴 **4,208 Forks**（+18）　/　🟢 **36 Open Issues**　/　JavaScript
...
⭐ **68,544 Stars**（+196）　🍴 **7,413 Forks**（+32）　/　🟢 **1,353 Open Issues**　/　TypeScript

Topics: `topicなし`

## 61位 [openinterpreter/openinterpreter](https://github.com/openinterpreter/openinterpreter)

A coding agent for open models like Kimi K3 and GLM 5.3

⭐ **68,368 Stars**（+17）　🍴 **5,883 Forks**（+1）　/　🟢 **3 Open Issues**　/　Rust
...
⭐ **67,466 Stars**（+438）　🍴 **9,497 Forks**（+75）　/　🟢 **634 Open Issues**　/　TypeScript
...
⭐ **67,372 Stars**（+18）　🍴 **10,946 Forks**（+20）　/　🟢 **55 Open Issues**　/　JavaScript

Topics: `ai` / `ai-agents` / `ai-prompts` / `anthropic` / `chatbot` / `chatgpt` / `claude` / `claude-code`

## 64位 [bradtraversy/design-resources-for-developers](https://github.com/bradtraversy/design-resources-for-developers)

Curated list of design and UI resources from stock photos, web templates, CSS frameworks, UI libraries, tools and much more

⭐ **66,968 Stars**（+13）　🍴 **12,188 Forks**（+4）　/　🟢 **129 Open Issues**　/　不明

Topics: `topicなし`

## 65位 [xtekky/gpt4free](https://github.com/xtekky/gpt4free)

The official gpt4free repository \| various collection of powerful language models \| opus 4.6 gpt 5.3 kimi 2.5 deepseek v3.2 gemini 3

⭐ **66,693 Stars**（-1）　🍴 **13,507 Forks**（-3）　/　🟢 **2 Open Issues**　/　Python
...
⭐ **66,569 Stars**（+60）　🍴 **4,798 Forks**（+7）　/　🟢 **910 Open Issues**　/　Python
...
⭐ **66,058 Stars**（+84）　🍴 **6,553 Forks**（+8）　/　🟢 **34 Open Issues**　/　HTML

Topics: `agentic-ai` / `agentic-coding` / `agentic-engineering` / `agentic-workflow` / `ai` / `ai-agents` / `anthropic` / `best-practices`

## 68位 [tt-a1i/archify](https://github.com/tt-a1i/archify)

Agent skill for beautiful, verifiable architecture, workflow, sequence, data-flow, and lifecycle diagrams—self-contained HTML with motion and crisp export.

⭐ **65,802 Stars**（+1,013）　🍴 **4,394 Forks**（+91）　/　🟢 **126 Open Issues**　/　JavaScript
...
⭐ **65,516 Stars**（+84）　🍴 **7,683 Forks**（+11）　/　🟢 **760 Open Issues**　/　Python
...
⭐ **65,158 Stars**（+61）　🍴 **12,612 Forks**（+4）　/　🟢 **206 Open Issues**　/　Python
...
⭐ **65,071 Stars**（+17）　🍴 **5,561 Forks**（±0）　/　🟢 **5,270 Open Issues**　/　Rust
...
⭐ **63,325 Stars**（+277）　🍴 **6,906 Forks**（+22）　/　🟢 **393 Open Issues**　/　Python
...
## 73位 [sansan0/TrendRadar](https://github.com/sansan0/TrendRadar)
...
⭐ **62,337 Stars**（+37）　🍴 **24,882 Forks**（+3）　/　🟢 **58 Open Issues**　/　Python
...
⭐ **62,228 Stars**（+75）　🍴 **5,426 Forks**（+2）　/　🟢 **118 Open Issues**　/　Python
...
⭐ **62,129 Stars**（+34）　🍴 **3,002 Forks**（+1）　/　🟢 **61 Open Issues**　/　TypeScript
...
⭐ **61,950 Stars**（+78）　🍴 **5,488 Forks**（+15）　/　🟢 **705 Open Issues**　/　PHP
...
⭐ **61,496 Stars**（+27）　🍴 **12,661 Forks**（+7）　/　🟢 **3 Open Issues**　/　Rust
...
⭐ **61,472 Stars**（+10）　🍴 **5,398 Forks**（+3）　/　🟢 **1 Open Issues**　/　不明
...
⭐ **61,024 Stars**（+17）　🍴 **9,229 Forks**（+8）　/　🟢 **1,074 Open Issues**　/　Python
...
⭐ **60,099 Stars**（+41）　🍴 **4,109 Forks**（+5）　/　🟢 **815 Open Issues**　/　Clojure

Topics: `clojure` / `clojurescript` / `design` / `prototyping` / `ui` / `ux-design` / `ux-experience`

## 81位 [calesthio/OpenMontage](https://github.com/calesthio/OpenMontage)

World's first open-source, agentic video production system. 12 production pipelines, 100+ tools, 700+ agent skill and production-knowledge files. Turn your AI coding assistant into a full video production studio.

⭐ **59,753 Stars**（+176）　🍴 **7,535 Forks**（+37）　/　🟢 **327 Open Issues**　/　Python
...
⭐ **59,318 Stars**（+14）　🍴 **2,710 Forks**（±0）　/　🟢 **308 Open Issues**　/　Rust
...
⭐ **59,130 Stars**（+28）　🍴 **7,559 Forks**（±0）　/　🟢 **729 Open Issues**　/　Python
...
⭐ **59,016 Stars**（+98）　🍴 **11,538 Forks**（+32）　/　🟢 **5,200 Open Issues**　/　Python
...
⭐ **58,709 Stars**（+45）　🍴 **8,493 Forks**（+16）　/　🟢 **342 Open Issues**　/　Python
...
⭐ **58,335 Stars**（+12）　🍴 **10,128 Forks**（+5）　/　🟢 **458 Open Issues**　/　Python
...
⭐ **57,516 Stars**（-1）　🍴 **7,618 Forks**（+3）　/　🟢 **9 Open Issues**　/　Python
...
⭐ **56,958 Stars**（+62）　🍴 **9,150 Forks**（+21）　/　🟢 **222 Open Issues**　/　TypeScript
...
⭐ **55,318 Stars**（+106）　🍴 **8,844 Forks**（+23）　/　🟢 **397 Open Issues**　/　Python
...
⭐ **55,009 Stars**（+200）　🍴 **4,359 Forks**（+14）　/　🟢 **1 Open Issues**　/　Python
...
⭐ **54,899 Stars**（+95）　🍴 **9,641 Forks**（+32）　/　🟢 **113 Open Issues**　/　Python
...
⭐ **54,822 Stars**（+475）　🍴 **6,823 Forks**（+38）　/　🟢 **699 Open Issues**　/　TypeScript
...
⭐ **54,394 Stars**（+32）　🍴 **6,256 Forks**（+4）　/　🟢 **361 Open Issues**　/　Rust
...
⭐ **53,155 Stars**（+47）　🍴 **6,001 Forks**（+2）　/　🟢 **61 Open Issues**　/　Python
...
⭐ **52,302 Stars**（+153）　🍴 **7,891 Forks**（+29）　/　🟢 **637 Open Issues**　/　Go
...
⭐ **52,201 Stars**（+64）　🍴 **4,012 Forks**（+100）　/　🟢 **101 Open Issues**　/　TypeScript

Topics: `browser` / `chrome` / `chrome-devtools` / `debugging` / `devtools` / `mcp` / `mcp-server` / `puppeteer`

## 97位 [CherryHQ/cherry-studio](https://github.com/CherryHQ/cherry-studio)

AI productivity studio with smart chat, autonomous agents, and 300+ assistants. Unified access to frontier LLMs

⭐ **51,928 Stars**（+56）　🍴 **4,978 Forks**（+10）　/　🟢 **1,547 Open Issues**　/　TypeScript

Topics: `agent-skills` / `ai-agent` / `claude-code` / `codex` / `deepseek` / `deepseek-harness` / `hermes-agent` / `skills`

## 98位 [charlax/professional-programming](https://github.com/charlax/professional-programming)

A collection of learning resources for curious software engineers

⭐ **51,520 Stars**（+3）　🍴 **4,020 Forks**（±0）　/　🟢 **9 Open Issues**　/　Python
...
⭐ **51,051 Stars**（+345）　🍴 **4,649 Forks**（+27）　/　🟢 **173 Open Issues**　/　TypeScript
...
⭐ **50,721 Stars**（+116）　🍴 **7,684 Forks**（+15）　/　🟢 **114 Open Issues**　/　JavaScript
...
## プッシュ順 1位 [zeroclaw-labs/zeroclaw](https://github.com/zeroclaw-labs/zeroclaw)

Fast, small, and fully autonomous AI personal assistant infrastructure, any OS, any platform — deploy anywhere, swap anything 🦀

⭐ **32,824 Stars**（-34）　🍴 **4,945 Forks**（+3）　/　Rust　/　最終プッシュ: 2026-09-17
...
⭐ **22,853 Stars**（+131）　🍴 **1,591 Forks**（+12）　/　HTML　/　最終プッシュ: 2026-09-17
...
⭐ **389,997 Stars**（+102）　🍴 **81,983 Forks**（+27）　/　TypeScript　/　最終プッシュ: 2026-09-17

Topics: `ai` / `assistant` / `crustacean` / `molty` / `openclaw` / `own-your-data` / `personal`

## プッシュ順 4位 [PostHog/posthog](https://github.com/PostHog/posthog)

:hedgehog: PostHog is the leading platform for building self-driving products. Our developer tools – AI observability, analytics, session replay, flags, experiments, error tracking, logs, and more – capture all the context agents need to diagnose problems, uncover opportunities, and ship fixes. Steer it all from Slack, web, desktop, or the MCP.

⭐ **39,838 Stars**（+20）　🍴 **3,394 Forks**（+6）　/　Python　/　最終プッシュ: 2026-09-17
...
⭐ **22,487 Stars**（+11）　🍴 **3,091 Forks**（±0）　/　TypeScript　/　最終プッシュ: 2026-09-17
...
⭐ **22,957 Stars**（+58）　🍴 **5,818 Forks**（+28）　/　TypeScript　/　最終プッシュ: 2026-09-17
...
⭐ **59,016 Stars**（+98）　🍴 **11,538 Forks**（+32）　/　Python　/　最終プッシュ: 2026-09-17
...
⭐ **36,110 Stars**（+44）　🍴 **8,955 Forks**（+32）　/　Python　/　最終プッシュ: 2026-09-17

Topics: `attention` / `blackwell` / `cuda` / `deepseek` / `diffusion` / `glm` / `gpt-oss` / `inference`

## プッシュ順 9位 [browserbase/stagehand](https://github.com/browserbase/stagehand)

The SDK to extract data and interact with any site on the web. Get started with Claude Code, Codex, Eve, Mastra, and more.

⭐ **24,323 Stars**（前日なし）　🍴 **1,685 Forks**（前日なし）　/　TypeScript　/　最終プッシュ: 2026-09-17

Topics: `agents` / `ai` / `ai-agents` / `browser-agent` / `browser-automation` / `cdp` / `cloud-browser` / `data-extraction`

## プッシュ順 10位 [herdrdev/herdr](https://github.com/herdrdev/herdr)

the runtime your coding agents live on

⭐ **39,238 Stars**（+229）　🍴 **2,958 Forks**（+25）　/　Rust　/　最終プッシュ: 2026-09-17
...
⭐ **35,590 Stars**（+10）　🍴 **2,400 Forks**（+1）　/　Go　/　最終プッシュ: 2026-09-17

Topics: `agent` / `agent-framework` / `ai-agent` / `ai-coding` / `cli` / `coding-agent` / `deepseek` / `developer-tools`

## プッシュ順 12位 [MODSetter/SurfSense](https://github.com/MODSetter/SurfSense)

Open-source NotebookLM alternative. Research the open web with live data(Reddit, YT, IG, TikTok, Indeed, Google Search, Maps etc) through one platform, API or MCP server. Join our Discord:

⭐ **16,160 Stars**（+1）　🍴 **1,537 Forks**（±0）　/　Python　/　最終プッシュ: 2026-09-17
...
⭐ **27,198 Stars**（+35）　🍴 **2,369 Forks**（+6）　/　Swift　/　最終プッシュ: 2026-09-17

Topics: `amp` / `claude-code` / `cli` / `codex` / `coding-agents` / `gemini` / `ghostty` / `macos`

## プッシュ順 14位 [microsoft/playwright](https://github.com/microsoft/playwright)

Playwright is a framework for Web Testing and Automation. It allows testing Chromium, Firefox and WebKit with a single API.

⭐ **96,281 Stars**（+53）　🍴 **6,456 Forks**（+8）　/　TypeScript　/　最終プッシュ: 2026-09-17

Topics: `automation` / `chrome` / `chromium` / `e2e-testing` / `electron` / `end-to-end-testing` / `firefox` / `javascript`

## プッシュ順 15位 [mastra-ai/mastra](https://github.com/mastra-ai/mastra)

Mastra is the modern TypeScript framework for AI-powered applications and agents.

⭐ **28,145 Stars**（+34）　🍴 **2,815 Forks**（+15）　/　TypeScript　/　最終プッシュ: 2026-09-17
...
⭐ **154,947 Stars**（+50）　🍴 **10,108 Forks**（+2）　/　Python　/　最終プッシュ: 2026-09-17

Topics: `agents` / `chatgpt` / `generative-ai` / `large-language-models` / `multiagent` / `react-flow`

## プッシュ順 17位 [semaphoreui/semaphore](https://github.com/semaphoreui/semaphore)

Modern UI and powerful API for Ansible, Terraform/OpenTofu/Terragrunt, PowerShell and other DevOps tools.

⭐ **14,152 Stars**（+2）　🍴 **1,307 Forks**（+1）　/　Go　/　最終プッシュ: 2026-09-17
...
⭐ **26,811 Stars**（-23）　🍴 **5,159 Forks**（+5）　/　TypeScript　/　最終プッシュ: 2026-09-17
...
⭐ **20,219 Stars**（+5）　🍴 **3,434 Forks**（-2）　/　TypeScript　/　最終プッシュ: 2026-09-17

Topics: `ai` / `ai-agents` / `llm`

## プッシュ順 20位 [lidge-jun/opencodex](https://github.com/lidge-jun/opencodex)

Universal provider proxy for OpenAI Codex & Claude Code — use any LLM (Claude, Gemini, Grok, DeepSeek, Ollama…) with Codex CLI, App, SDK, and Claude Code

⭐ **15,138 Stars**（+241）　🍴 **1,144 Forks**（+21）　/　TypeScript　/　最終プッシュ: 2026-09-17

Topics: `ai-gateway` / `ai-tools` / `anthropic` / `chatgpt` / `claude` / `claude-code` / `codex` / `codex-cli`

## プッシュ順 21位 [XiaomiMiMo/MiMo-Code](https://github.com/XiaomiMiMo/MiMo-Code)

MiMo Code: Where Models and Agents Co-Evolve

⭐ **13,170 Stars**（+31）　🍴 **1,359 Forks**（+5）　/　TypeScript　/　最終プッシュ: 2026-09-17

Topics: `ai` / `ai-agents` / `cli` / `mimo` / `mimo-code`

## プッシュ順 22位 [pydantic/pydantic-ai](https://github.com/pydantic/pydantic-ai)

How Python does AI. Agents, realtime voice, image generation, embeddings. Every model, every interface, typed end to end.

⭐ **20,014 Stars**（+26）　🍴 **2,728 Forks**（+3）　/　Python　/　最終プッシュ: 2026-09-17

Topics: `agent-framework` / `genai` / `harness` / `harness-engineering` / `llm` / `pydantic` / `python`

## プッシュ順 23位 [coder/coder](https://github.com/coder/coder)

Secure environments for developers and their agents

⭐ **14,809 Stars**（+205）　🍴 **1,485 Forks**（+7）　/　Go　/　最終プッシュ: 2026-09-17

Topics: `agents` / `dev-tools` / `development-environment` / `go` / `golang` / `ide` / `jetbrains` / `remote-development`

## プッシュ順 24位 [topoteretes/cognee](https://github.com/topoteretes/cognee)

Cognee is the open-source AI memory platform for agents. Give your AI agents persistent long-term memory across sessions with a self-hosted knowledge graph engine.

⭐ **30,788 Stars**（+41）　🍴 **3,051 Forks**（+12）　/　Python　/　最終プッシュ: 2026-09-17
...
⭐ **76,315 Stars**（+66）　🍴 **6,956 Forks**（+11）　/　Python　/　最終プッシュ: 2026-09-17
...
⭐ **181,662 Stars**（+372）　🍴 **9,835 Forks**（+12）　/　TypeScript　/　最終プッシュ: 2026-09-17

Topics: `ai` / `ai-agents` / `ai-crawler` / `ai-scraping` / `ai-search` / `crawler` / `data-extraction` / `html-to-markdown`

## プッシュ順 27位 [paperclipai/paperclip](https://github.com/paperclipai/paperclip)

The open-source app everyone uses to manage agents at work

⭐ **80,944 Stars**（+78）　🍴 **14,855 Forks**（+10）　/　TypeScript　/　最終プッシュ: 2026-09-17

Topics: `topicなし`

## プッシュ順 28位 [windmill-labs/windmill](https://github.com/windmill-labs/windmill)

Open-source developer platform to power your entire infra and turn scripts into webhooks, workflows and UIs. Fastest workflow engine (13x vs Airflow). Open-source alternative to Retool and Temporal.

⭐ **17,958 Stars**（+5）　🍴 **1,096 Forks**（-1）　/　Rust　/　最終プッシュ: 2026-09-17

Topics: `low-code` / `open-source` / `platform` / `postgresql` / `python` / `self-hostable` / `typescript`

## プッシュ順 29位 [cline/cline](https://github.com/cline/cline)

Autonomous coding agent as an SDK, IDE extension, or CLI assistant.

⭐ **68,544 Stars**（+196）　🍴 **7,413 Forks**（+32）　/　TypeScript　/　最終プッシュ: 2026-09-17

Topics: `topicなし`

## プッシュ順 30位 [Skyvern-AI/skyvern](https://github.com/Skyvern-AI/skyvern)

Automate browser based workflows with AI

⭐ **23,021 Stars**（+5）　🍴 **2,165 Forks**（+2）　/　Python　/　最終プッシュ: 2026-09-17
