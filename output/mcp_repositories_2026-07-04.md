...
⭐ **446,597 Stars**（+264）　🍴 **49,034 Forks**（+42）　/　🟢 **1,498 Open Issues**　/　Python
...
⭐ **246,183 Stars**（+681）　🍴 **21,830 Forks**（+70）　/　🟢 **322 Open Issues**　/　Shell
...
⭐ **226,020 Stars**（+345）　🍴 **34,572 Forks**（+59）　/　🟢 **51 Open Issues**　/　JavaScript
...
⭐ **209,191 Stars**（+514）　🍴 **38,170 Forks**（+161）　/　🟢 **25,789 Open Issues**　/　Python
...
⭐ **194,552 Stars**（+20）　🍴 **109,832 Forks**（-14）　/　🟢 **22 Open Issues**　/　Rust
...
⭐ **187,571 Stars**（+366）　🍴 **19,246 Forks**（+48）　/　🟢 **122 Open Issues**　/　不明
...
⭐ **175,460 Stars**（+65）　🍴 **16,833 Forks**（+10）　/　🟢 **3,394 Open Issues**　/　Go
...
⭐ **158,219 Stars**（+247）　🍴 **18,651 Forks**（+26）　/　🟢 **1,004 Open Issues**　/　Python
...
⭐ **156,527 Stars**（+996）　🍴 **13,468 Forks**（+72）　/　🟢 **119 Open Issues**　/　Shell
...
⭐ **151,123 Stars**（+60）　🍴 **9,429 Forks**（+9）　/　🟢 **978 Open Issues**　/　Python
...
⭐ **144,232 Stars**（+535）　🍴 **8,303 Forks**（+30）　/　🟢 **386 Open Issues**　/　TypeScript
...
⭐ **141,522 Stars**（+33）　🍴 **34,776 Forks**（+6）　/　🟢 **154 Open Issues**　/　不明
...
⭐ **136,072 Stars**（+249）　🍴 **21,886 Forks**（+31）　/　🟢 **9,719 Open Issues**　/　Python
...
⭐ **127,017 Stars**（+556）　🍴 **20,610 Forks**（+84）　/　🟢 **99 Open Issues**　/　Shell
...
⭐ **119,440 Stars**（+221）　🍴 **17,806 Forks**（+50）　/　🟢 **773 Open Issues**　/　TypeScript
...
⭐ **117,985 Stars**（+223）　🍴 **10,430 Forks**（+16）　/　🟢 **389 Open Issues**　/　Python
...
⭐ **113,180 Stars**（+347）　🍴 **7,525 Forks**（+32）　/　🟢 **1,718 Open Issues**　/　Rust
...
⭐ **105,739 Stars**（+8）　🍴 **14,205 Forks**（+6）　/　🟢 **1,344 Open Issues**　/　TypeScript
...
⭐ **102,717 Stars**（+226）　🍴 **11,377 Forks**（+22）　/　🟢 **282 Open Issues**　/　Python
...
⭐ **100,778 Stars**（+369）　🍴 **10,620 Forks**（+42）　/　🟢 **123 Open Issues**　/　Python
...
⭐ **95,676 Stars**（+183）　🍴 **13,935 Forks**（+41）　/　🟢 **52 Open Issues**　/　Python
...
⭐ **95,272 Stars**（+3）　🍴 **9,474 Forks**（+1）　/　🟢 **263 Open Issues**　/　TypeScript
...
⭐ **92,204 Stars**（+45）　🍴 **6,036 Forks**（+3）　/　🟢 **163 Open Issues**　/　TypeScript
...
⭐ **90,824 Stars**（+217）　🍴 **17,545 Forks**（+47）　/　🟢 **291 Open Issues**　/　Python
...
⭐ **88,379 Stars**（+6）　🍴 **59,507 Forks**（±0）　/　🟢 **839 Open Issues**　/　TypeScript
...
⭐ **88,053 Stars**（+31）　🍴 **11,151 Forks**（+11）　/　🟢 **633 Open Issues**　/　TypeScript
...
⭐ **85,828 Stars**（+135）　🍴 **7,420 Forks**（+16）　/　🟢 **248 Open Issues**　/　JavaScript
...
⭐ **84,580 Stars**（+3）　🍴 **24,725 Forks**（-2）　/　🟢 **31 Open Issues**　/　Blade
...
⭐ **83,914 Stars**（+1,020）　🍴 **4,676 Forks**（+52）　/　🟢 **355 Open Issues**　/　JavaScript
...
⭐ **79,418 Stars**（+104）　🍴 **10,111 Forks**（+21）　/　🟢 **342 Open Issues**　/　Python

Topics: `agent` / `artificial-intelligence` / `chatgpt` / `claude-ai` / `cli` / `developer-tools` / `gpt` / `llm`

## 31位 [Graphify-Labs/graphify](https://github.com/Graphify-Labs/graphify)

AI coding assistant skill (Claude Code, Codex, OpenCode, Cursor, Gemini CLI, and more). Turn any folder of code, SQL schemas, R scripts, shell scripts, docs, papers, images, or videos into a queryable knowledge graph. App code + database schema + infrastructure in one graph.

⭐ **77,651 Stars**（前日なし）　🍴 **7,690 Forks**（前日なし）　/　🟢 **435 Open Issues**　/　Python
...
⭐ **76,094 Stars**（+82）　🍴 **10,287 Forks**（+16）　/　🟢 **943 Open Issues**　/　Python
...
⭐ **74,954 Stars**（+263）　🍴 **8,563 Forks**（+43）　/　🟢 **526 Open Issues**　/　TypeScript

Topics: `agent-skills` / `ai-agents` / `ai-design` / `byok` / `claude-code-for-design` / `claude-design` / `codex-design` / `coding-agents`

## 34位 [DietrichGebert/ponytail](https://github.com/DietrichGebert/ponytail)

Makes your AI agent think like the laziest senior dev in the room. The best code is the code you never wrote.

⭐ **73,878 Stars**（+903）　🍴 **3,874 Forks**（+68）　/　🟢 **151 Open Issues**　/　JavaScript

Topics: `agent-skills` / `ai-agents` / `claude` / `claude-code` / `claude-code-plugin` / `cursor-rules` / `developer-tools` / `llm`

## 35位 [opendatalab/MinerU](https://github.com/opendatalab/MinerU)

Transforms complex documents like PDFs and Office docs into LLM-ready markdown/JSON for your Agentic workflows.

⭐ **73,391 Stars**（+146）　🍴 **6,160 Forks**（+12）　/　🟢 **29 Open Issues**　/　Python

Topics: `ai4science` / `document-analysis` / `docx` / `extract-data` / `layout-analysis` / `ocr` / `parser` / `pdf`

## 36位 [abi/screenshot-to-code](https://github.com/abi/screenshot-to-code)

Drop in a screenshot and convert it to clean code (HTML/Tailwind/React/Vue)

⭐ **73,161 Stars**（+10）　🍴 **9,010 Forks**（+2）　/　🟢 **124 Open Issues**　/　Python

Topics: `topicなし`

## 37位 [thedaviddias/Front-End-Checklist](https://github.com/thedaviddias/Front-End-Checklist)

🗂 The essential checklist for modern web development, for humans and AI agents

⭐ **73,123 Stars**（+5）　🍴 **6,647 Forks**（±0）　/　🟢 **3 Open Issues**　/　MDX
...
⭐ **72,719 Stars**（+63）　🍴 **13,563 Forks**（+10）　/　🟢 **4,965 Open Issues**　/　TypeScript
...
⭐ **72,703 Stars**（+120）　🍴 **4,104 Forks**（+5）　/　🟢 **2,740 Open Issues**　/　TypeScript
...
⭐ **72,299 Stars**（-17）　🍴 **5,669 Forks**（±0）　/　🟢 **441 Open Issues**　/　不明
...
⭐ **70,942 Stars**（+110）　🍴 **7,296 Forks**（+12）　/　🟢 **121 Open Issues**　/　Python
...
⭐ **70,856 Stars**（+204）　🍴 **5,879 Forks**（+31）　/　🟢 **261 Open Issues**　/　TypeScript
...
⭐ **70,030 Stars**（+29）　🍴 **7,083 Forks**（+2）　/　🟢 **70 Open Issues**　/　Python
...
⭐ **69,813 Stars**（+67）　🍴 **11,377 Forks**（+14）　/　🟢 **48 Open Issues**　/　Python
...
⭐ **68,927 Stars**（+168）　🍴 **7,480 Forks**（+25）　/　🟢 **131 Open Issues**　/　Shell
...
⭐ **68,497 Stars**（+212）　🍴 **4,235 Forks**（+14）　/　🟢 **1,485 Open Issues**　/　Rust
...
⭐ **68,069 Stars**（+133）　🍴 **6,736 Forks**（+22）　/　🟢 **0 Open Issues**　/　Python
...
⭐ **67,805 Stars**（+20）　🍴 **6,097 Forks**（+4）　/　🟢 **1,052 Open Issues**　/　Python
...
⭐ **66,459 Stars**（+2）　🍴 **13,556 Forks**（-2）　/　🟢 **5 Open Issues**　/　Python
...
⭐ **66,296 Stars**（+8）　🍴 **12,107 Forks**（+1）　/　🟢 **48 Open Issues**　/　不明
...
⭐ **64,817 Stars**（+85）　🍴 **5,295 Forks**（+6）　/　🟢 **825 Open Issues**　/　TypeScript
...
⭐ **64,273 Stars**（+21）　🍴 **6,840 Forks**（+12）　/　🟢 **1,209 Open Issues**　/　TypeScript
...
⭐ **64,268 Stars**（+6）　🍴 **5,582 Forks**（+1）　/　🟢 **273 Open Issues**　/　Rust
...
⭐ **62,998 Stars**（+148）　🍴 **7,410 Forks**（+16）　/　🟢 **726 Open Issues**　/　TypeScript
...
⭐ **62,800 Stars**（+36）　🍴 **5,175 Forks**（+14）　/　🟢 **4,504 Open Issues**　/　Rust
...
⭐ **62,642 Stars**（+58）　🍴 **4,411 Forks**（+8）　/　🟢 **933 Open Issues**　/　Python
...
⭐ **61,970 Stars**（+43）　🍴 **6,197 Forks**（+7）　/　🟢 **12 Open Issues**　/　HTML
...
⭐ **61,538 Stars**（+60）　🍴 **6,624 Forks**（+4）　/　🟢 **332 Open Issues**　/　TypeScript

Topics: `editor` / `oss` / `videoeditor`

## 59位 [koala73/worldmonitor](https://github.com/koala73/worldmonitor)

Real-time global intelligence dashboard. AI-powered news aggregation, geopolitical monitoring, and infrastructure tracking in a unified situational awareness interface

⭐ **61,332 Stars**（前日なし）　🍴 **9,545 Forks**（前日なし）　/　🟢 **206 Open Issues**　/　TypeScript

Topics: `ai` / `dashboard` / `geopolitics` / `monitoring` / `news` / `opensource` / `osint` / `palantir`

## 60位 [sansan0/TrendRadar](https://github.com/sansan0/TrendRadar)
...
⭐ **60,242 Stars**（+29）　🍴 **24,762 Forks**（+1）　/　🟢 **49 Open Issues**　/　Python
...
⭐ **60,090 Stars**（+53）　🍴 **6,966 Forks**（+7）　/　🟢 **503 Open Issues**　/　Python

Topics: `agents` / `ai` / `ai-agents` / `application` / `chatbots` / `chatgpt` / `genai` / `llm`

## 62位 [microsoft/autogen](https://github.com/microsoft/autogen)

A programming framework for agentic AI

⭐ **59,488 Stars**（+18）　🍴 **8,959 Forks**（+5）　/　🟢 **922 Open Issues**　/　Python
...
⭐ **58,693 Stars**（+130）　🍴 **4,082 Forks**（+13）　/　🟢 **455 Open Issues**　/　TypeScript

Topics: `ai` / `context-engineering` / `engineering` / `planning` / `prd` / `sdd` / `sdlc` / `spec`

## 64位 [upstash/context7](https://github.com/upstash/context7)

Context7 Platform -- Up-to-date code documentation for LLMs and AI code editors

⭐ **58,579 Stars**（+40）　🍴 **2,748 Forks**（+4）　/　🟢 **40 Open Issues**　/　TypeScript

Topics: `llm` / `mcp` / `mcp-server` / `vibe-coding`

## 65位 [meilisearch/meilisearch](https://github.com/meilisearch/meilisearch)

A lightning-fast search engine API bringing AI-powered hybrid search to your sites and applications.

⭐ **58,407 Stars**（+17）　🍴 **2,605 Forks**（+1）　/　🟢 **306 Open Issues**　/　Rust

Topics: `ai` / `api` / `app-search` / `database` / `enterprise-search` / `faceting` / `full-text-search` / `fuzzy-search`

## 66位 [coollabsio/coolify](https://github.com/coollabsio/coolify)

An open-source, self-hostable PaaS alternative to Vercel, Heroku & Netlify that lets you easily deploy static sites, databases, full-stack applications and 280+ one-click services on your own servers.

⭐ **57,884 Stars**（+52）　🍴 **4,920 Forks**（+8）　/　🟢 **811 Open Issues**　/　PHP
...
⭐ **57,531 Stars**（+185）　🍴 **3,540 Forks**（+12）　/　🟢 **270 Open Issues**　/　TypeScript

Topics: `topicなし`

## 68位 [zylon-ai/private-gpt](https://github.com/zylon-ai/private-gpt)

Interact with your documents using the power of GPT, 100% privately, no data leaks

⭐ **57,306 Stars**（±0）　🍴 **7,596 Forks**（-1）　/　🟢 **7 Open Issues**　/　Python

Topics: `ai` / `ai-tools` / `on-premise`

## 69位 [MemPalace/mempalace](https://github.com/MemPalace/mempalace)

The best-benchmarked open-source AI memory system. And it's free.

⭐ **56,948 Stars**（+27）　🍴 **7,356 Forks**（+5）　/　🟢 **569 Open Issues**　/　Python

Topics: `ai` / `chromadb` / `llm` / `mcp` / `memory` / `python`

## 70位 [headroomlabs-ai/headroom](https://github.com/headroomlabs-ai/headroom)

Compress tool outputs, logs, files, and RAG chunks before they reach the LLM. 60-95% fewer tokens, same answers. Library, proxy, MCP server.

⭐ **56,526 Stars**（+287）　🍴 **4,128 Forks**（+31）　/　🟢 **537 Open Issues**　/　Python
...
⭐ **56,460 Stars**（+914）　🍴 **3,861 Forks**（+61）　/　🟢 **38 Open Issues**　/　JavaScript
...
⭐ **55,295 Stars**（+69）　🍴 **11,180 Forks**（+16）　/　🟢 **177 Open Issues**　/　Python
...
⭐ **54,971 Stars**（+53）　🍴 **3,589 Forks**（+12）　/　🟢 **667 Open Issues**　/　Clojure
...
⭐ **54,899 Stars**（+44）　🍴 **7,702 Forks**（+16）　/　🟢 **612 Open Issues**　/　Python

Topics: `agents` / `ai` / `ai-agents` / `aiagentframework` / `llms`

## 75位 [BerriAI/litellm](https://github.com/BerriAI/litellm)

Python SDK, Proxy Server (AI Gateway) to call 100+ LLM APIs in OpenAI (or native) format, with cost tracking, guardrails, loadbalancing and logging. [Bedrock, Azure, OpenAI, VertexAI, Cohere, Anthropic, Sagemaker, HuggingFace, VLLM, NVIDIA NIM]

⭐ **52,607 Stars**（+67）　🍴 **9,468 Forks**（+25）　/　🟢 **3,646 Open Issues**　/　Python

Topics: `ai-gateway` / `anthropic` / `azure-openai` / `bedrock` / `gateway` / `langchain` / `litellm` / `llm`

## 76位 [charlax/professional-programming](https://github.com/charlax/professional-programming)

A collection of learning resources for curious software engineers

⭐ **51,218 Stars**（±0）　🍴 **3,997 Forks**（±0）　/　🟢 **3 Open Issues**　/　Python
...
⭐ **50,642 Stars**（+31）　🍴 **5,448 Forks**（+9）　/　🟢 **284 Open Issues**　/　Rust
...
⭐ **50,602 Stars**（+780）　🍴 **4,041 Forks**（+68）　/　🟢 **125 Open Issues**　/　Python

Topics: `agent-infrastructure` / `ai-agent` / `ai-search` / `automation` / `bilibili` / `claude-code` / `cli` / `cursor`

## 79位 [bmad-code-org/BMAD-METHOD](https://github.com/bmad-code-org/BMAD-METHOD)

Breakthrough Method for Agile Ai Driven Development

⭐ **50,068 Stars**（+19）　🍴 **5,762 Forks**（+2）　/　🟢 **81 Open Issues**　/　JavaScript
...
⭐ **49,075 Stars**（+2）　🍴 **4,218 Forks**（+2）　/　🟢 **3 Open Issues**　/　不明
...
⭐ **48,926 Stars**（+211）　🍴 **4,047 Forks**（+18）　/　🟢 **78 Open Issues**　/　Python

Topics: `ai-prompts` / `ai-skill` / `bluesky` / `claude` / `claude-code` / `clawhub` / `deep-research` / `hackernews`

## 82位 [oobabooga/textgen](https://github.com/oobabooga/textgen)

Open-source desktop app for local LLMs. Text, vision, tool-calling, OpenAI/Anthropic-compatible API. 100% private.

⭐ **47,417 Stars**（+5）　🍴 **5,986 Forks**（+1）　/　🟢 **824 Open Issues**　/　Python

Topics: `topicなし`

## 83位 [mudler/LocalAI](https://github.com/mudler/LocalAI)

LocalAI is the open-source AI engine. Run any model - LLMs, vision, voice, image, video - on any hardware. No GPU required.

⭐ **47,313 Stars**（+9）　🍴 **4,198 Forks**（+3）　/　🟢 **209 Open Issues**　/　Go

Topics: `agents` / `ai` / `api` / `audio-generation` / `decentralized` / `distributed` / `image-generation` / `libp2p`

## 84位 [GitHubDaily/GitHubDaily](https://github.com/GitHubDaily/GitHubDaily)

坚持分享 GitHub 上高质量、有趣实用的开源技术教程、开发者工具、编程网站、技术资讯。A list cool, interesting projects of GitHub.

⭐ **46,970 Stars**（+7）　🍴 **4,649 Forks**（±0）　/　🟢 **674 Open Issues**　/　不明
...
⭐ **46,941 Stars**（+4）　🍴 **16,080 Forks**（±0）　/　🟢 **40 Open Issues**　/　Java

Topics: `activiti` / `agent` / `ai` / `antd` / `claude-code` / `cli` / `codegenerator` / `codex`

## 86位 [serverless/serverless](https://github.com/serverless/serverless)
...
⭐ **46,911 Stars**（±0）　🍴 **5,729 Forks**（±0）　/　🟢 **1,222 Open Issues**　/　JavaScript
...
⭐ **46,394 Stars**（+1）　🍴 **2,259 Forks**（±0）　/　🟢 **2,643 Open Issues**　/　TypeScript

Topics: `cockroachdb` / `database` / `javascript` / `mariadb` / `mongo` / `mongodb` / `mongodb-orm` / `mssql`

## 88位 [apache/airflow](https://github.com/apache/airflow)

Apache Airflow - A platform to programmatically author, schedule, and monitor workflows

⭐ **46,029 Stars**（+10）　🍴 **17,348 Forks**（+8）　/　🟢 **1,647 Open Issues**　/　Python
...
⭐ **45,922 Stars**（+35）　🍴 **3,318 Forks**（+8）　/　🟢 **289 Open Issues**　/　Python

Topics: `topicなし`

## 90位 [zhayujie/CowAgent](https://github.com/zhayujie/CowAgent)

Open-source super AI assistant & Agent Harness. Plans tasks, runs tools and skills, self-evolves with memory and knowledge. Multi-model, multi-channel. Lightweight, extensible, one-line install. (formerly chatgpt-on-wechat)

⭐ **45,789 Stars**（+15）　🍴 **10,250 Forks**（+1）　/　🟢 **25 Open Issues**　/　Python
...
⭐ **45,759 Stars**（+289）　🍴 **2,978 Forks**（+25）　/　🟢 **90 Open Issues**　/　TypeScript
...
⭐ **45,415 Stars**（+23）　🍴 **5,267 Forks**（+1）　/　🟢 **22 Open Issues**　/　TypeScript

Topics: `penetration-testing` / `pentesting` / `security-audit` / `security-automation` / `security-tools`

## 93位 [HKUDS/nanobot](https://github.com/HKUDS/nanobot)

Lightweight, open-source AI agent for your tools, chats, and workflows.

⭐ **45,010 Stars**（+22）　🍴 **7,939 Forks**（+2）　/　🟢 **878 Open Issues**　/　Python
...
⭐ **44,711 Stars**（+43）　🍴 **4,185 Forks**（+4）　/　🟢 **69 Open Issues**　/　Python
...
⭐ **43,585 Stars**（+44）　🍴 **4,864 Forks**（+5）　/　🟢 **250 Open Issues**　/　TypeScript
...
⭐ **43,485 Stars**（+191）　🍴 **2,462 Forks**（+21）　/　🟢 **55 Open Issues**　/　JavaScript

Topics: `topicなし`

## 97位 [janhq/jan](https://github.com/janhq/jan)

Jan is an open source alternative to ChatGPT that runs 100% offline on your computer.

⭐ **43,392 Stars**（+20）　🍴 **2,876 Forks**（±0）　/　🟢 **376 Open Issues**　/　TypeScript

Topics: `chatgpt` / `gpt` / `llamacpp` / `llm` / `localai` / `open-source` / `self-hosted` / `tauri`

## 98位 [ccxt/ccxt](https://github.com/ccxt/ccxt)

A cryptocurrency trading API with more than 100 exchanges in JavaScript / TypeScript / Python / C# / PHP / Go / Java

⭐ **43,181 Stars**（+15）　🍴 **8,726 Forks**（+4）　/　🟢 **1,307 Open Issues**　/　Python

Topics: `altcoin` / `api` / `arbitrage` / `bitcoin` / `bot` / `btc` / `crypto` / `cryptocurrencies`

## 99位 [gradio-app/gradio](https://github.com/gradio-app/gradio)

Build and share delightful machine learning apps, all in Python. 🌟 Star to support our work!

⭐ **43,061 Stars**（±0）　🍴 **3,533 Forks**（+3）　/　🟢 **234 Open Issues**　/　Python

Topics: `data-analysis` / `data-science` / `data-visualization` / `deep-learning` / `deploy` / `gradio` / `gradio-interface` / `interface`

## 100位 [danielmiessler/Fabric](https://github.com/danielmiessler/Fabric)

Fabric is an open-source framework for augmenting humans using AI. It provides a modular system for solving specific problems using a crowdsourced set of AI prompts that can be used anywhere.

⭐ **42,810 Stars**（+21）　🍴 **4,200 Forks**（+1）　/　🟢 **69 Open Issues**　/　Go
...
⭐ **16,040 Stars**（+203）　🍴 **1,427 Forks**（+18）　/　TypeScript　/　最終プッシュ: 2026-07-04
...
⭐ **23,618 Stars**（+69）　🍴 **1,871 Forks**（+6）　/　Swift　/　最終プッシュ: 2026-07-04
...
⭐ **19,642 Stars**（+15）　🍴 **1,899 Forks**（+1）　/　Rust　/　最終プッシュ: 2026-07-04

Topics: `agents` / `agi` / `ai` / `ai-memory` / `audio-recording` / `computer-vision` / `hermes` / `hermes-agent`

## プッシュ順 4位 [ogulcancelik/herdr](https://github.com/ogulcancelik/herdr)

agent multiplexer that lives in your terminal.

⭐ **11,409 Stars**（+662）　🍴 **668 Forks**（+32）　/　Rust　/　最終プッシュ: 2026-07-04

Topics: `agent` / `agent-orchestration` / `ai` / `ai-agents` / `claude-code` / `cli` / `codex` / `coding-agents`

## プッシュ順 5位 [Yeachan-Heo/oh-my-claudecode](https://github.com/Yeachan-Heo/oh-my-claudecode)

Teams-first Multi-agent orchestration for Claude Code

⭐ **37,403 Stars**（+32）　🍴 **3,375 Forks**（+5）　/　TypeScript　/　最終プッシュ: 2026-07-04

Topics: `agentic-coding` / `ai-agents` / `automation` / `claude` / `claude-code` / `multi-agent-systems` / `oh-my-opencode` / `opencode`

## プッシュ順 6位 [ruvnet/ruflo](https://github.com/ruvnet/ruflo)

🌊 The leading agent meta-harness. Deploy intelligent multi-player swarms, coordinate autonomous workflows, and build conversational AI systems. Features adaptiv...

⭐ **62,998 Stars**（+148）　🍴 **7,410 Forks**（+16）　/　TypeScript　/　最終プッシュ: 2026-07-04

Topics: `agentic-ai` / `agentic-framework` / `agentic-rag` / `agentic-workflow` / `agents` / `ai-agents` / `ai-assistant` / `ai-coding`

## プッシュ順 7位 [weaviate/weaviate](https://github.com/weaviate/weaviate)

Weaviate is an open-source vector database that stores both objects and vectors, allowing for the combination of vector search with structured filtering with the fault tolerance and scalability of a cloud-native database​.

⭐ **16,493 Stars**（+4）　🍴 **1,333 Forks**（+1）　/　Go　/　最終プッシュ: 2026-07-04
...
⭐ **12,498 Stars**（±0）　🍴 **1,464 Forks**（+1）　/　Rust　/　最終プッシュ: 2026-07-04
...
⭐ **15,860 Stars**（+99）　🍴 **1,331 Forks**（+8）　/　Swift　/　最終プッシュ: 2026-07-04
...
⭐ **12,011 Stars**（+353）　🍴 **803 Forks**（+32）　/　TypeScript　/　最終プッシュ: 2026-07-04

Topics: `ade` / `agent-ide` / `ai-agents` / `claude-code` / `cli` / `codex` / `cursor-agent` / `devtools`

## プッシュ順 11位 [chenhg5/cc-connect](https://github.com/chenhg5/cc-connect)
...
⭐ **13,521 Stars**（+39）　🍴 **1,282 Forks**（+8）　/　Go　/　最終プッシュ: 2026-07-04

Topics: `topicなし`

## プッシュ順 12位 [different-ai/openwork](https://github.com/different-ai/openwork)

An open-source alternative to Claude Cowork (powered by opencode)

⭐ **16,623 Stars**（+28）　🍴 **1,684 Forks**（+6）　/　TypeScript　/　最終プッシュ: 2026-07-04

Topics: `topicなし`

## プッシュ順 13位 [Gitlawb/openclaude](https://github.com/Gitlawb/openclaude)

runs anywhere. uses anything

⭐ **29,764 Stars**（+18）　🍴 **8,857 Forks**（+3）　/　TypeScript　/　最終プッシュ: 2026-07-04
...
⭐ **52,607 Stars**（+67）　🍴 **9,468 Forks**（+25）　/　Python　/　最終プッシュ: 2026-07-04

Topics: `ai-gateway` / `anthropic` / `azure-openai` / `bedrock` / `gateway` / `langchain` / `litellm` / `llm`

## プッシュ順 15位 [QwenLM/qwen-code](https://github.com/QwenLM/qwen-code)

An open-source AI coding agent that lives in your terminal.

⭐ **25,779 Stars**（+19）　🍴 **2,600 Forks**（+4）　/　TypeScript　/　最終プッシュ: 2026-07-04
...
⭐ **10,100 Stars**（+5）　🍴 **1,158 Forks**（+1）　/　Python　/　最終プッシュ: 2026-07-04

Topics: `agent` / `agents` / `ai` / `anthropic` / `claudecode` / `llm` / `llms` / `openai`

## プッシュ順 17位 [emdash-cms/emdash](https://github.com/emdash-cms/emdash)

EmDash is a full-stack TypeScript CMS based on Astro; the spiritual successor to WordPress

⭐ **11,031 Stars**（+8）　🍴 **1,012 Forks**（±0）　/　TypeScript　/　最終プッシュ: 2026-07-04

Topics: `astro` / `cms` / `emdash` / `typescript`

## プッシュ順 18位 [modelcontextprotocol/inspector](https://github.com/modelcontextprotocol/inspector)

Visual testing tool for MCP servers

⭐ **10,275 Stars**（+8）　🍴 **1,394 Forks**（+3）　/　TypeScript　/　最終プッシュ: 2026-07-04

Topics: `topicなし`

## プッシュ順 19位 [modelcontextprotocol/servers](https://github.com/modelcontextprotocol/servers)

Model Context Protocol Servers

⭐ **88,053 Stars**（+31）　🍴 **11,151 Forks**（+11）　/　TypeScript　/　最終プッシュ: 2026-07-04
...
⭐ **209,191 Stars**（+514）　🍴 **38,170 Forks**（+161）　/　Python　/　最終プッシュ: 2026-07-04

Topics: `ai` / `ai-agent` / `ai-agents` / `anthropic` / `chatgpt` / `claude` / `claude-code` / `clawdbot`

## プッシュ順 21位 [SimplifyJobs/New-Grad-Positions](https://github.com/SimplifyJobs/New-Grad-Positions)

A collection of full time roles in SWE, Quant, and PM for new grads.

⭐ **17,292 Stars**（+4）　🍴 **1,298 Forks**（±0）　/　不明　/　最終プッシュ: 2026-07-04

Topics: `applications` / `coderquad` / `college` / `fulltime` / `hacktoberfest` / `jobs` / `newgrad` / `position`

## プッシュ順 22位 [teng-lin/notebooklm-py](https://github.com/teng-lin/notebooklm-py)

Unofficial Python API and agentic skill for Google NotebookLM. Full programmatic access to NotebookLM's features—including capabilities the web UI doesn't expose—via Python, CLI, and AI agents like Claude Code, Codex, and OpenClaw.

⭐ **17,188 Stars**（+39）　🍴 **2,333 Forks**（+1）　/　Python　/　最終プッシュ: 2026-07-04
...
⭐ **12,932 Stars**（+1）　🍴 **2,101 Forks**（+3）　/　Dart　/　最終プッシュ: 2026-07-04

Topics: `ai` / `app` / `bci` / `c` / `flutter` / `friend` / `mobile` / `necklace`

## プッシュ順 24位 [micro/go-micro](https://github.com/micro/go-micro)

A Go agent harness and service framework

⭐ **22,919 Stars**（+4）　🍴 **2,408 Forks**（±0）　/　Go　/　最終プッシュ: 2026-07-04
...
⭐ **14,386 Stars**（+9）　🍴 **2,206 Forks**（+4）　/　TypeScript　/　最終プッシュ: 2026-07-04

Topics: `context` / `context-layer` / `data-catalog` / `data-collaboration` / `data-contracts` / `data-discovery` / `data-governance` / `data-lineage`

## プッシュ順 26位 [paperclipai/paperclip](https://github.com/paperclipai/paperclip)

The open-source app everyone uses to manage agents at work

⭐ **72,719 Stars**（+63）　🍴 **13,563 Forks**（+10）　/　TypeScript　/　最終プッシュ: 2026-07-04

Topics: `topicなし`

## プッシュ順 27位 [davila7/claude-code-templates](https://github.com/davila7/claude-code-templates)

CLI tool for configuring and monitoring Claude Code

⭐ **28,447 Stars**（+12）　🍴 **2,975 Forks**（+2）　/　Python　/　最終プッシュ: 2026-07-04
...
⭐ **12,049 Stars**（+9）　🍴 **1,035 Forks**（±0）　/　TypeScript　/　最終プッシュ: 2026-07-04

Topics: `ai` / `ai-agents` / `coding` / `deno` / `embeddings` / `insforge` / `nextjs` / `oauth2`

## プッシュ順 29位 [xpipe-io/xpipe](https://github.com/xpipe-io/xpipe)

Access your entire server infrastructure from your local desktop

⭐ **14,231 Stars**（+3）　🍴 **540 Forks**（±0）　/　Java　/　最終プッシュ: 2026-07-04

Topics: `bash` / `docker` / `filemanager` / `files` / `incus` / `java` / `javafx` / `k8s`

## プッシュ順 30位 [MetaMask/metamask-extension](https://github.com/MetaMask/metamask-extension)

:globe_with_meridians: :electric_plug: The MetaMask browser extension enables browsing Ethereum blockchain enabled websites

⭐ **13,167 Stars**（+6）　🍴 **5,556 Forks**（+3）　/　TypeScript　/　最終プッシュ: 2026-07-04
